...
class QRBucket {
  late String bucketFileName, qrCodeBytes;
  QRBucket({required this.bucketFileName, required this.qrCodeBytes});
}
    ...
    if (response.statusCode == 200 || response.statusCode == 201) {
      try {
        ...
        if (responseString.isNotEmpty) {
          return QRBucket(bucketFileName: responseString, qrCodeBytes: Uint8Converter.uint8ListToString(fileBytes));
        } else {
