...
class MobileScannerOneController extends ValueNotifier<MobileScannerState> {
  /// Construct a new [MobileScannerOneController] instance.
  MobileScannerOneController({
    this.autoStart = true,
  ...
  void _throwIfNotInitialized() {
    if (!value.isInitialized) {
      throw const MobileScannerException(
        ...
        errorDetails: MobileScannerErrorDetails(
          message: 'The MobileScannerOneController has not been initialized.',
        ),
      );
    }
    ...
    if (_isDisposed) {
      throw const MobileScannerException(
        ...
        errorDetails: MobileScannerErrorDetails(
          message:
          'The MobileScannerOneController was used after it has been disposed.',
        ),
      );
    }
  }
  ...
  Future<void> start({CameraFacing? cameraDirection}) async {
    ...
    pp('$mm Do nothing if the camera is already running.');
    if (value.isRunning) {
      return;
    }
  ...
  static const mm = '🍎🍎🍎🍎 MobileScannerOneController 🍎';
