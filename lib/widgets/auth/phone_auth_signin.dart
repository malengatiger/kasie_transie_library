...
class CellPhoneAuthSigninState extends State<CellPhoneAuthSignin>
  ...
  Future _setTexts() async {
    ...
    loadingRoutes = await translator.translate(loadingRoutes, c.locale);
  ...
  String loadingRoutes = 'Wait data';
    ...
    return SafeArea(
      ...
      appBar: AppBar(
        ...
        bottom: const PreferredSize(
            preferredSize: Size.fromHeight(20), child: Column()),
      ),
      body: Stack(
        children: [
          Padding(
